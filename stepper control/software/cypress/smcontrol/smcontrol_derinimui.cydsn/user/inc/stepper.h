...
#define COEF_MIN    0.1L
#define COEF_MAX    1.0L
    
/* makrosas apskaiciuoja variklio srove is duoto diapazono UNI_MIN_CURRENT_DEF ... UNI_MAX_CURRENT_DEF  koeficientu */
#define CURR2COEF(X) ( (double)COEF_MIN + ( (double)X - UNI_MIN_CURRENT_DEF ) * \
                    ( (double)(( COEF_MAX - COEF_MIN )/( UNI_MAX_CURRENT_DEF - UNI_MIN_CURRENT_DEF )) ) )
...
#define UNI_CURRENT_DEF         ( 1.4L )          // UNI variklio srove Amperais default
#define UNI_MIN_CURRENT_DEF     ( 0.8L )        // UNI tipo variklio MIN srove amperais
